    ...
    >
      ...
      >
        ...
        <button
          ...
          className="flex items-center justify-center w-8 h-7 self-center shrink-0 rounded text-gray-500 hover:text-gray-300 hover:bg-gray-800/50 transition-colors"
          title="New tab"
        >
      ...
      {isWin && (
        ...
        >
          <button
            ...
            className="w-11 flex items-center justify-center text-gray-400 hover:bg-gray-700 hover:text-gray-100 transition-colors"
            title="Minimize"
          >

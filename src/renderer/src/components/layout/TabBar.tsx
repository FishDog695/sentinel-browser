...
export function TabBar() {
  ...
  return (
    <div
      className="h-10 bg-[var(--shell-bg)] border-b border-[var(--shell-border)] flex items-stretch shrink-0"
    ...
    >
      ...
      >
          ...
          return (
            <button
              ...
              className={[
                ...
                isActive
                  ? 'h-9 bg-[var(--shell-tab-active-bg)] text-[var(--shell-tab-active-text)] border-t-2 border-t-[var(--shell-tab-active-border)]'
                  : 'h-7 bg-[var(--shell-tab-inactive-bg)] text-[var(--shell-text-muted)] hover:bg-[var(--shell-hover-bg)] hover:text-gray-300 border-t-2 border-t-transparent',
              ].join(' ')}
              title={title}
            >
              {/* Favicon */}
              ...
              <span
                ...
                className={[
                  ...
                  'opacity-0 group-hover:opacity-100 hover:bg-[var(--shell-hover-bg)]',
                  isActive ? 'opacity-40' : '',
                ].join(' ')}
              >
        ...
        <button
          ...
          className="flex items-center justify-center w-8 h-7 self-center shrink-0 rounded text-[var(--shell-text-muted)] hover:text-gray-300 hover:bg-[var(--shell-hover-bg)] transition-colors"
          title="New tab"
        >
      ...
      {isWin && (
        ...
        >
          <button
            ...
            className="w-11 flex items-center justify-center text-gray-400 hover:bg-[var(--shell-hover-bg)] hover:text-gray-100 transition-colors"
            title="Minimize"
          >
